...
import type { Progress } from "./app-progress-edit-dialog";
...
interface FilterDialogProps {
  ...
  filterTypeActivity: string | undefined;
  filterActivityStatus: string | undefined;
  filterTypeClient: string | undefined;
  filterSource: string | undefined;
  
  setFilterTypeActivityAction: (val: string | undefined) => void; 
...
export function ProgressFilterDialog({
  open,
  onOpenChangeAction,
  progress,
  filterTypeActivity,
  ...
  filterTypeClient,
  filterSource,
  setFilterTypeActivityAction,
  setFilterActivityStatusAction,
  setFilterTypeClientAction,
  setFilterSourceAction,
  resetFiltersAction,
}: FilterDialogProps) {
  const uniqueValues = (key: keyof Progress) =>
    [...new Set(progress.map((a) => a[key]).filter(Boolean))].sort() as string[];
    ...
    <Dialog open={open} onOpenChange={onOpenChangeAction}>
      <DialogContent className="max-w-md rounded-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Apply additional filters to refine your progress list.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="space-y-1">
            ...
            <Select
              value={filterTypeActivity ?? "all"}
              onValueChange={(value) =>
                setFilterTypeActivityAction(value === "all" ? undefined : value)
              }
            >
              ...
              <SelectContent>
                <SelectGroup>
                  ...
                  {uniqueValues("typeactivity").map((s) => (
